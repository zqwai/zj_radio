...
jQuery.imgpreload(the_images,
{
	...
	all: function()
	{
		...
		jLazyBgInit();
		$('.adWelcome').addClass('enterAdPlay').show();
		setTimeout(function(){
...
//enterAdvertising
function enterAd(){
	$('.enterAdPlay .J_bg').fadeIn(500,function(){
		$('.enterAdPlay .box-text li:nth-child(1)').show().animo( { animation: 'fadeInLeft', duration: 0.2});
		$('.enterAdPlay .box-text li:nth-child(2)').show().animo( { animation: 'fadeInRight', duration:0.2},function() {
			$('.enterAdPlay .btn-enter').show().animo( { animation: 'fadeInUp', duration: 0.6},function() {
				$('.enterAdPlay .t-advert .t-platform').show().animo( { animation: 'zoomIn', duration: 0.1},function() {
				$('.enterAdPlay .t-advert .t-tree').show().animo( { animation: 'fadeInUp', duration: 0.2},function() {
				$('.enterAdPlay .t-advert .t-hill').show().animo( { animation: 'fadeInUp', duration: 0.2},function() {
					$('.enterAdPlay .t-advert .t-cloud-b').fadeIn(500);
					$('.enterAdPlay .t-advert .t-notbook').show().animo( { animation: 'bounceInDown', duration: 0.3},function() {
					$('.enterAdPlay .t-advert .t-cloud-s').fadeIn(500);
					$('.enterAdPlay .t-advert .t-phone').show().animo( { animation: 'bounceInDown', duration: 0.3},function() {	
					});	
					});
				});
				});
...
//outAdvertising
function outAd(){
	$('.enterAdPlay .J_bg').hide();
	$('.enterAdPlay .box-text li').hide();
	$('.enterAdPlay .btn-enter').hide();
	$('.enterAdPlay .t-advert li').hide();
}
document.getElementById('btnEnter5').addEventListener('touchstart',function(){
	$('.adWelcome').removeClass('enterAdPlay').hide();
	outAd();
