...
function enterAdvertising(){
	$('.slide6 .J_bg').fadeIn(500,function(){
		$('.slide6 .round-1').fadeIn(500,function(){
		$('.slide6 .round-2').fadeIn(500,function(){
		$('.slide6 .round-3').fadeIn(500,function(){
			$('.slide6 .main').fadeIn(1000,function(){
				$('.slide6 .btn-enter').fadeIn(10).animate({'bottom':'10%'});
			});
		});
		});
		});
...
function outAdvertising(){
	...
	$('.slide6 .main').hide();
	$('.slide6 .round').hide();
	$('.slide6 .btn-enter').removeAttr('style');
}
